...
(async () => {
  while(true) {
    try {
      const currentState = {}
      const chatItems = document.querySelectorAll("div.c-virtual_list__scroll_container > div.p-channel_sidebar__static_list__item div.p-channel-sidebar__channel--unread")
